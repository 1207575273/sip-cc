...
pub fn video_start(
    ...
    let wal = app.state::<WalLogger>();
    warn_if_macos_missing_monitor_index(&app, &wal, "VIDEO", region.monitor_index);
...
pub fn video_stop(
    ...
    let copy_video_to_clipboard = config_manager
        .config
        .lock()
        .map_err(|e| e.to_string())?
        .video_copy_to_clipboard;
